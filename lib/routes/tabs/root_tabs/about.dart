      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Text("About", style: TextStyle(fontSize: 36),),
          ),
          Padding(
            padding: EdgeInsets.all(32),
            child: Column(
              children: [
                Text("$APP_NAME is an application designed to help promote medical transparency between users and their doctors. "
                ...
                SizedBox(height: 20,),
                Text("$APP_NAME solves this problem by giving users concise information on medication that doctors prescribe to them by simply taking pictures of their pill bottle."
